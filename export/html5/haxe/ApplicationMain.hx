...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("NightHunt", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("NightHunt", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "NightHunt";
		app.meta["name"] = "NightHunt";
